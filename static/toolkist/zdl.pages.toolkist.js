        ...
        "main" : [
            {
                ...
                "displayName" : "My Corn Dried Up '^'",
                "hash" : "F154859E514D27715E2E9DA272158FF758909C48",
                "manualRecords" : [
                    { "user" : "Albert", "time" : 240, "splits" : "1|2|3" },
                    { "user" : "Charlie" },
                    { "user" : "Bradley" }
                ],
                "manualCreators" : ["Kernkob", "Hydro"],
                "description" : "...",
                "tier" : "S"
            },
            {
...
function RenderZDLList(containerID, levelData, type)
{
    ...
    levelData.forEach(level => 
    {
        ...
        var authorTime = $('<div>').addClass('zdl-authorTime').append($('<div>').addClass('zdl-authorTime-medal')).append($('<span>').text(toolkist.util.ConvertSecondsToDisplayTime(level.authorTime)))
